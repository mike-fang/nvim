...
_G.packer_plugins = {
  ...
  delimitMate = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/delimitMate",
  ...
  supertab = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/supertab",
  ...
  ["vim-colors-solarized"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/vim-colors-solarized",
    url = "https://github.com/altercation/vim-colors-solarized"
  },
  ["vim-mundo"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/vim-mundo",
    url = "https://github.com/simnalamburt/vim-mundo"
  },
  ["vim-peekaboo"] = {
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/vim-peekaboo",
